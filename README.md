...
> 帮我安装 ZotPilot skill：clone https://github.com/xunhe730/ZotPilot.git 到正确的 skills 目录（Claude Code: `~/.claude/skills/zotpilot`，OpenCode: `~/.config/opencode/skills/zotpilot`，Codex: `~/.codex/skills/zotpilot`，Gemini: `~/.gemini/skills/zotpilot`），然后帮我配置 Zotero 文献库。
