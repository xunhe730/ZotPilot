...
if [[ $BUILD_BROWSER_EXT == 1 ]]; then
	...
	# ZotPilot: append branded progress window CSS to build output only
	cat "$CWD/src/browserExt/progressWindow-zotpilot.css" >> "$BUILD_DIR/browserExt/progressWindow/progressWindow.css"
fi
